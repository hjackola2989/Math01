...
public class math {
	...
	
	{
		...
		public static double cylinderVolume(double radius, double height) {
			// TODO Auto-generated method stub
			return Math.pow (radius, 2) * 3.14 * height ;
		}
		public static double coneVolume(double radius, double height) {
			// TODO Auto-generated method stub
			return Math.pow (radius, 2) * 3.14 * height / 3 ;
		}
		public static double sphereVolume(double radius) {
			// TODO Auto-generated method stub
			return Math.pow (radius, 3) * 3.14 * 4 / 3 ;
		}
		...
		public static double squarePrismSurfaceArea(double side, double height) {
			// TODO Auto-generated method stub
			return Math.pow (side , 2) * 2 + 4 * side  * height ;
		}
		...
		public static double sphereSurfaceArea(double radius) {
			// TODO Auto-generated method stub
			return Math.pow (radius , 2) * 4 * 3.14;
		}
